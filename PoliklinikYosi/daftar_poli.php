...
if (isset($_POST['simpan'])) {
    if (isset($_POST['id'])) {
        ...
        $jumlahPasien = mysqli_query($mysqli, "SELECT COUNT(*) as jumlah FROM daftar_poli WHERE id_jadwal='" . $_POST['id_jadwal'] . "'");
        $dataJumlahPasien = mysqli_fetch_assoc($jumlahPasien);
        $nomorAntrian = $dataJumlahPasien['jumlah'] + 1;

        $_POST['no_antrian'] = $nomorAntrian;
                ...
                <form class="form row" method="POST" action="" name="myForm" onsubmit="return(validate());">
                    ...
                    <div class="form-group">
                        <label for="inputNoAntrian" class="form-label fw-bold">
                            No Antrian akan otomatis tergenerate setelah pendaftaran.
                        </label>
                    </div>
                    <div class="form-group">
