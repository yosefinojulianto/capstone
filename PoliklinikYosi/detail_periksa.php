                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="id_periksa">
                            ...
                            while ($data = mysqli_fetch_array($periksa)) {
                                ...
                                ?>
                                <option value="<?php echo $data['id'] ?>" <?php echo $selected ?>><?php echo $data['catatan'] . ' - Rp. ' . $data['biaya_periksa'] ?></option>
                            <?php
                            }
                            ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="id_obat">
                            ...
                            while ($data = mysqli_fetch_array($obat)) {
                                ...
                                ?>
                                <option value="<?php echo $data['id'] ?>" <?php echo $selected ?>><?php echo 'Rp. ' . $data['harga'] .' - '. $data['nama_obat'] . ' - ' . $data['kemasan'] ?></option>
                            <?php
                            }
                            ?>
                        </select>
